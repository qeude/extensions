...
export async function updateTodoStatus(pageId: string, labelId: string | null): Promise<any> {
  try {
    ...
    if (isNotionClientError(err)) {
      ...
      showToast(Toast.Style.Failure, "Error occurred check that you have a Label property");
    }
    return undefined;
  }
}
